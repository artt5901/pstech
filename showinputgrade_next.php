  ...
  <div class="container" >
    <div class="card text-center">
      <div class="container-fluid h-100 bg-light text-dark">
		...
		inner join year as year on (classroom.y_id = year.y_id)
		WHERE classroom.y_id = '$y_id' AND classroom.class_id = '$class_id' AND classroom_st = '3' ORDER BY classroom.day_id ASC";					
				$result2 = mysqli_query($conn, $sql2)
                  ...
                  ?>
                    ...
                    <td><?php echo "$rs2[class_name]"; ?></td>
                      ...
                      <td><?php echo "<a href=\"next_grade_course.php?classroom_id=$rs2[classroom_id]\">"; ?><button type="button" class="btn btn-info">กรอกเกรดต่อจากเดิม</button><?php echo "</a>"; ?></td>
                    </tr>
                  <?php
                  }
                  mysqli_close($conn);
