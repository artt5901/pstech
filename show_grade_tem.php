...
$y_id = $_GET['y_id'];
$sql = "SELECT (sum(score*c_credit)/sum(c_credit)) as grade , grade.s_username , stu.s_name , class.class_name , year.y_number , year.y_id
				FROM grade as grade inner join student as stu on (grade.s_username = stu.s_username)
									...
									WHERE grade.s_username = '$valid_username' AND grade.y_id = '$y_id'";
          ...
          <div class="row no-gutters">
            <div class="col-md-12">
              <table class="table table-hover" >
                <thead><div class="col"><?php echo "<a href=\"print_grade.php?s_username=$rs[s_username]&y_id=$rs[y_id]\">"; ?><button class="col-3 btn btn-success btn-sm float-center" >พิมพ์รายงานผลการเรียนนักศึกษา</button><?php echo "</a>"; ?></div>
