...
<div class="card text-center">
  <div class="card-header">
    <ul class="nav nav-pills card-header-pills">
      ...
      <li class="nav-item">
        <a class="nav-link" href="frm_addclassroom.php">เพิ่มตารางสอน</a>
      </li>
				...
				$result2 = mysqli_query($conn, $sql2)
                  ...
                  ?>
                    ...
                    <td><?php echo "$rs2[class_name]"; ?></td>
                      <td><?php echo "<a href=\"showclassroom_tree.php?y_id=$rs2[y_id]&class_id=$rs2[class_id]\">"; ?>
                      <button type="button" class="btn btn-info">ดูตารางสอน</button>
					  <?php echo "</a>"; ?></td>
                    </tr>
                  <?php
                  }
