...
$sql = "SELECT *
				FROM student where st_id = '1'
					GROUP BY s_year  HAVING count(s_year) > 0	ORDER BY s_year DESC";
...
<div class="card text-center">
  ...
  <div class="container" >
    ...
    <h1>แสดงข้อมูลนักศึกษา : ที่ต้องการสำเร็จการศึกษา</h1>    
  </div>
                ...
                <tbody>
                  ...
                  ?><tr>
                    <td><?php echo "$rs[s_year]"; ?></td>
                      <td><?php echo "<a href=\"showsuccess_first.php?s_year=$rs[s_year]\">"; ?>
                      <button type="button" class="btn btn-warning">แสดงหมู่เรียน</button>
					  <?php echo "</a>"; ?></td>
                    </tr>
                  <?php
                  }
