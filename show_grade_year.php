...
$sql = "SELECT (sum(score*c_credit)/sum(c_credit)) as grade , grade.s_username , stu.s_name , class.class_name , year.y_number 
				FROM grade as grade inner join student as stu on (grade.s_username = stu.s_username)
									...
									WHERE grade.s_username = '$valid_username' ";
          ...
          <div class="row no-gutters">
            <div class="col-md-12">
              <table class="table table-hover" >
                <thead> <div class="col"><?php echo "<a href=\"print_grade_year.php?s_username=$rs[s_username]\">"; ?><button class="col-3 btn btn-success btn-sm float-center" >พิมพ์รายงานผลการเรียนนักศึกษา</button><?php echo "</a>"; ?></div>
