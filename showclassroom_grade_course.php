    ...
    <div class="container-fluid h-100 bg-light text-dark">
      ...
      <div class="row justify-content-center align-items-center h-100">
        <div class="col col-sm-6 col-md-6 col-lg-4 col-xl-6">
          <form id="form1" name="form1" method="post" enctype="multipart/form-data" action="input_grade.php">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p>คุณต้องการกรอกเกรดวิชา <?php echo "$rs[c_name]"; ?> หรือไม่?</p>
                  </div>
      ...
      <div class="form-group">
        <div class="container">
          <div class="row">
            <div class="col"><button class="col-6 btn btn-info btn-sm float-right" data-toggle="modal" data-target="#myModal" >Next</button></div>
