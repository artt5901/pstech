  ...
  <div class="container" >
    <div class="card text-center">
				...
				WHERE s_year = '$s_year'
                  ...
                  ?><tr>
                    ...
                    <td><?php echo "$rs[class_name]"; ?></td>
                      ...
                      <button type="button" class="btn btn-info">กำลังศึกษา</button>
					  <?php echo "</a>"; ?></td>
                      <td><?php echo "<a href=\"showstudent_success.php?class_id=$rs[class_id]\">"; ?>
                      <button type="button" class="btn btn-success">สำเร็จการศึกษา</button>
					  <?php echo "</a>"; ?></td>
                      <td><?php echo "<a href=\"showstudent_out.php?class_id=$rs[class_id]\">"; ?>
                      <button type="button" class="btn btn-danger">ลาออก</button>
					  <?php echo "</a>"; ?></td>
                    </tr>
                  <?php
                  }
      ...
      <div class="form-group">
        <div class="container">
          <div class="row">
            <div class="col"><button class="col-6 btn btn-success btn-sm float-right" data-toggle="modal" data-target="#myModal">สำเร็จการศึกษา</button></div>
