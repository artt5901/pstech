...
<table class="table table-hover"  id="mytable">
  <thead><div class="col"><?php echo "<a href=\"print_parent.php?\">"; ?><button class="col-3 btn btn-success btn-sm float-center" >พิมพ์รายงานข้อมูลผู้ปกครอง</button><?php echo "</a>"; ?></div>
