            ...
            <form id="form1" name="form1" method="POST" enctype="multipart/form-data" action="addclassroom.php">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="b_id" id="branch" required>
                ...
                <div class="form-group">
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col"><button class="col-6 btn btn-secondary btn-sm float-left" type="reset" input onClick="refreshPage()">ล้างข้อมูล</button></div>

                    </div>
                  </div>
                  <br>
                  <label class="text-danger" for="inputclass"><strong>*หมายเหตุ*</strong></label>
                  <label class="text-danger" for="inputclass">หากต้องการเลือกสาขา หรือหมู่เรียนใหม่ กรุณากด <strong>"ล้างข้อมูล"</strong> ก่อนทุกครั้ง เพื่อไม่ให้เกิดความผิดพลาด</label>
                </div>
              </div>
            </form>
          </div>
