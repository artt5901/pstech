...
?>
<title>Delete Department Information To Phasaktara</title>
...
<div class="container-fluid h-100 bg-light text-dark">
  ...
  <div class="row justify-content-center align-items-center h-100">
    <div class="col col-sm-6 col-md-6 col-lg-4 col-xl-3">
      <form id="form1" name="form1" method="post" action="deldepartment.php">
        ...
        <div class="form-group">
          <input name="d_name" input type="text" class="form-control" disabled="disabled" id="d_name" value="<?php echo "$rs[d_name]";?>" />
        ...
        <div class="form-group">
          <div class="container">
            <div class="row">
              <div class="col"><button class="col-6 btn btn-danger btn-sm float-center" data-toggle="modal" data-target="#myModal">Delete</button></div>
