...
$sql = "SELECT *
				FROM student 
					where st_id = '3' GROUP BY s_year  HAVING count(s_year) > 0	ORDER BY s_year DESC";
...
<div class="card text-center">
  ...
  <div class="container" >
    ...
    <h1>แสดงข้อมูลนักศึกษา : ลาออก</h1>    
  </div>
                ...
                <tbody>
                  ...
                  ?><tr>
                    <td><?php echo "$rs[s_year]"; ?></td>
                      ...
                      <button type="button" class="btn btn-danger">แสดงหมู่เรียน</button>
					  <?php echo "</a>"; ?></td>
                    </tr>
                  <?php
                  }
