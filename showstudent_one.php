...
<div class="card text-center">
  ...
  <div class="container" >
    ...
    <h1>แสดงข้อมูลนักศึกษา : กำลังศึกษาอยู่</h1>    
  </div>
                ...
                <tbody>
                  ...
                  ?><tr>
                    <td><?php echo "$rs[s_year]"; ?></td>
                      <td><?php echo "<a href=\"showstudent_first.php?s_year=$rs[s_year]\">"; ?>
                      <button type="button" class="btn btn-info">แสดงหมู่เรียน</button>
					  <?php echo "</a>"; ?></td>
                    </tr>
                  <?php
                  }
