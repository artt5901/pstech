    ...
    <div class="container">
      <div class="card text-center">
              ...
              <div class="col-md-12">
                <table class="table table-hover">
                  ...
                  <thead>
                    ...
                    <div class="col"><?php echo "<a href=\"print_student.php?class_id=$rs[class_id]\">"; ?><button class="col-2 btn btn-success btn-sm float-center">ออกรายงานข้อมูลนักศึกษา</button><?php echo "</a>"; ?></div>
                  </thead>
                  <table class="table table-hover" id="mytable-student">
                    <thead>
                      <tr class="bg-info text-white">
        ...
        <div class="form-group">
          <div class="container">
            <div class="row">
              <div class="col"><button class="col-2 btn btn-secondary btn-sm float-center" input type="button" onclick=window.history.back()>ย้อนกลับ</button></div>
            </div>
          </div>
        </div>
      </div>
