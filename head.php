  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">ครู/อาจารย์</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">ตารางสอน</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">ประมวลผลการเรียน</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">ข่าวสาร</a>
        </li>
        <li class="nav-item">
          <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">ค้นหา</a>
        </li>
      </ul>
      <form class="d-flex">
