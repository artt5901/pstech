...
$y_id = $_GET['y_id'];
$sql = "SELECT (sum(score*c_credit)/sum(c_credit)) as grade_score , grade.s_username , stu.s_name , class.class_name , year.y_number , grade.y_id , branch.b_name
...
<h2 align="center">ปีการศึกษา/ภาคเรียน : '.$rs['y_number'].'  ผลการเรียนเฉลี่ย : '.$rs['grade_score'].'</h2>
<table>
        <tr>
			<th>รหัสวิชา</th>
            <th>รายวิชา</th>
